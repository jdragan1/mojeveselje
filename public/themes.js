...
const CUSTOM_THEMES = [
  ...
  },
  {
    ...
    css: `
      ...
      #view-app[data-theme="vencanje"][data-style="romansa"] .v-hero{ position:relative; overflow:hidden; }
      #view-app[data-theme="vencanje"][data-style="romansa"] .v-hero:before,
      #view-app[data-theme="vencanje"][data-style="romansa"] .v-hero:after{
        content:'♥'; position:absolute; color:rgba(241,78,149,.18); font-size:34px; pointer-events:none;
        animation: romFloat 6s ease-in-out infinite;
      }
      #view-app[data-theme="vencanje"][data-style="romansa"] .v-hero:before{ top:12%; left:8%; animation-delay:0s; }
      #view-app[data-theme="vencanje"][data-style="romansa"] .v-hero:after{ bottom:14%; right:9%; font-size:26px; animation-delay:1.6s; }
      @keyframes romFloat{ 0%,100%{ transform:translateY(0) rotate(-6deg); } 50%{ transform:translateY(-16px) rotate(6deg); } }
      #view-app[data-theme="vencanje"][data-style="romansa"] .v-names{ font-size:clamp(42px,9vw,80px); font-weight:400; position:relative; z-index:1; }
      #view-app[data-theme="vencanje"][data-style="romansa"] .v-kicker{ color:var(--v-accent); text-transform:none; font-style:italic; font-family:'Work Sans',sans-serif; position:relative; z-index:1; }
      ...
      #view-app[data-theme="vencanje"][data-style="romansa"] .v-person img{ border:3px solid var(--v-accent); transition:transform .4s ease; }
      #view-app[data-theme="vencanje"][data-style="romansa"] .v-person:hover img{ transform:scale(1.05) rotate(-2deg); }
      #view-app[data-theme="vencanje"][data-style="romansa"] .v-event-card{ border-radius:50px 4px 50px 4px; box-shadow:0 14px 34px -18px rgba(241,78,149,.4); }
      #view-app[data-theme="vencanje"][data-style="romansa"] .v-gallery img{ border-radius:16px; }
      #view-app[data-theme="vencanje"][data-style="romansa"] .v-submit{ border-radius:30px; box-shadow:0 10px 24px -10px rgba(241,78,149,.55); }
    `
  },
  {
    id: 'noc',
  ...
  },
  {
    ...
    css: `
      ...
      #view-app[data-theme="ostalo"][data-style="svemir"] .v-hero{ background-color:#161A33; position:relative; overflow:hidden; }
      #view-app[data-theme="ostalo"][data-style="svemir"] .v-hero:after{
        content:''; position:absolute; inset:0; pointer-events:none;
        background-image:
        ...
        animation: svTwinkle 3s ease-in-out infinite;
      }
      @keyframes svTwinkle{ 0%,100%{opacity:.5;} 50%{opacity:1;} }
      #view-app[data-theme="ostalo"][data-style="svemir"] .v-names{ text-shadow:3px 3px 0 var(--v-accent2); font-weight:800; position:relative; z-index:1; }
      #view-app[data-theme="ostalo"][data-style="svemir"] .v-kicker{ background:var(--v-accent); color:#0D0F22; display:inline-block; padding:6px 16px; border-radius:20px; font-weight:700; position:relative; z-index:1; }
      #view-app[data-theme="ostalo"][data-style="svemir"] .v-event-card,
      #view-app[data-theme="ostalo"][data-style="svemir"] .v-detail-card,
      #view-app[data-theme="ostalo"][data-style="svemir"] .v-person,
      #view-app[data-theme="ostalo"][data-style="svemir"] .v-gift-card{ border-radius:20px; border:2px solid var(--v-accent); }
